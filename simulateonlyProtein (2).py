...
parser.add_argument("-z", "--step-size", type=float, default=0.004, help="Step size (ps")
...
parser.add_argument("-e", "--equilibration-steps", type=int, default=100, help="Number of equilibration steps")
